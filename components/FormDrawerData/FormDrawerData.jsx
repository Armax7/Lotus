...
useEffect(() => {
  ...
  await axios.put(`http://localhost:3000/api/user-details`, {
    id: uuid,
    name: newData.name,
        ...
        <Chakra.DrawerContent>
          ...
          <Chakra.DrawerBody className={style.drawerBody}>
            <Chakra.FormControl id="name" mb="4">
              ...
              <Chakra.Input type="text" name="name" value={newData.name || ""} onChange={handleChange} />
            </Chakra.FormControl>

            <Chakra.FormControl id="address" mb="4">
              <Chakra.FormLabel>Dirección</Chakra.FormLabel>
              <Chakra.Input name="address" value={newData.address || ""} onChange={handleChange} />
            </Chakra.FormControl>
